...
<html lang="en">
    ...
    <body class="min-vh-100 m-0 p-0">
        <div class="container-fluid m-0 p-0" id="main-container">
            <div class="row border vh-100" id="column-with-background">
                <div class="col-md vh-100">
		</div>
		<div class="col-md p-0 vh-100 bg-light">
		    <form class="d-flex flex-column p-5 m-0">
		        <h1 class="fs-3 mb-3 text-center">Charred Manual: A D&D 5e Character Manager</h1>
                        ...
                        <input class="mx-1 my-2" type="text" id="username" name="username">
                        <label for="password" class="text-sm-center text-lg-start">Password</label>
                        <input class="mx-1 mb-4" type="password" id="password" name="password">
                        <button class="mt-2 mb-4" type="submit">Login</button>
		        <p class="text-center mt-1">Don't have an account? <a href="">Register here</a><p>
		    </form>
                </div>
            </div>
        </div>
